	...
	<section class="section dashboard">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title" style="text-align: center;">Teacher Details</h5>
						<br>
						<div style="overflow-x:auto;">
							<table class="table table-striped" style="text-align:center; white-space:nowrap;font-size: 15px; " id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									<?php if (empty($teacher_management)) : ?>
										<tr>
											<td colspan="9">- No Data Available In Table -</td>
										</tr>
									<?php else : ?>
										<?php foreach ($teacher_management as $value) : ?>
											<tr>
												<td><?= $value->t_id ?></td>
												<td><?= $value->t_name ?></td>
												<td><?= $value->t_nic ?></td>
												...
												<td><?= $value->t_email ?></td>
												<td>
													<a href="<?= BASE ?>Sample/update_teacher?t_id=<?= $value->t_id ?>"><i class="bi bi-pencil"></i></a> |

	...
	<section class="section dashboard">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title" style="text-align: center;">Student Details</h5>
						<br>
						<div style="overflow-x:auto;">
							<table class="table table-striped" style="text-align:center; white-space:nowrap;font-size: 15px; " id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									<?php if (empty($student_management)) : ?>
										<tr>
											<td colspan="10">- No Data Available In Table -</td>
										</tr>
									<?php else : ?>
										<?php foreach ($student_management as $value) : ?>
											<tr>
												<td><?= $value->id ?></td>
												<td><?= $value->name ?></td>
												<td><?= $value->dob ?></td>
												...
												<td><?= $value->grade ?></td>
												<td>
													<a href="<?= BASE ?>Sample/update_student?id=<?= $value->id ?>"><i class="bi bi-pencil"></i></a> |
